...
const SizedStockIcon sized_stock_icons [] = {
	...
	{ PIDGIN_STOCK_DIALOG_AUTH,     "status", "dialog-auth.png",      FALSE, TRUE,  FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
	{ PIDGIN_STOCK_DIALOG_COOL,     "status", "dialog-cool.png",      FALSE, FALSE, FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
	{ PIDGIN_STOCK_DIALOG_ERROR,    "status", "dialog-error.png",     FALSE, TRUE,  FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
	{ PIDGIN_STOCK_DIALOG_INFO,     "status", "dialog-information.png",      FALSE, TRUE,  FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
	{ PIDGIN_STOCK_DIALOG_MAIL,     "status", "dialog-mail.png",      FALSE, TRUE,  FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
	{ PIDGIN_STOCK_DIALOG_QUESTION, "status", "dialog-question.png",  FALSE, TRUE,  FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
	{ PIDGIN_STOCK_DIALOG_WARNING,  "status", "dialog-warning.png",   FALSE, FALSE, FALSE, FALSE, FALSE, TRUE,  FALSE, NULL },
